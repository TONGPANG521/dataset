...
train_root = "train_data_path"  
val_root = "validation_data_path"  
...
def main(args):
    ...
    if args.weights != "":
        ...
        # Remove the weights related to classification categories.
    ...
    # Save the metrics during training.
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-path', type=str, default="/data/crack_images")
    parser.add_argument('--weights', type=str, default='xx.pt', help='initial weights path')
